  ...
  const content = (
    <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl shadow-2xl overflow-hidden`}>
      ...
      <div className={`${darkMode ? 'bg-gray-800 border-b border-gray-700' : 'bg-white border-b border-gray-100'} px-8 py-8 text-center`}>
        ...
        <h1 className={`text-2xl font-bold mb-2 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Patient Portal</h1>
        <p className={`${darkMode ? 'text-gray-400' : 'text-gray-500'} text-sm`}>Access your health records anytime, anywhere</p>
      </div>
      ...
      <div className="px-8 py-8">
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <Link to="/patient/forgot-password" className={`${darkMode ? 'text-gray-300 hover:text-white' : 'text-gray-600 hover:text-gray-900'} font-medium`}>
              Forgot password?
            </Link>
          </div>
        ...
        <div className="mt-6 space-y-3">
          <Link
            ...
            className={`block w-full text-center px-4 py-3 border-2 ${darkMode ? 'border-gray-600 text-gray-300 hover:bg-gray-700' : 'border-gray-300 text-gray-700 hover:bg-gray-50'} font-medium rounded-lg transition-all`}
          >
          ...
          <Link
            ...
            className="block w-full text-center px-4 py-3 border-2 border-red-500 text-red-600 font-medium rounded-lg hover:bg-red-50 transition-all"
          >
        ...
        {!isEmbedded && (
          <div className={`mt-6 text-center text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            ...
            <Link to="/patient/signup" className={`${darkMode ? 'text-white hover:text-gray-200' : 'text-gray-900 hover:text-gray-700'} font-semibold`}>
              Register here
            </Link>
          </div>
        )}
