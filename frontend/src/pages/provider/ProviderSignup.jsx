...
const ProviderSignup = () => {
  ...
  if (showOTP) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-indigo-50 to-blue-100 px-4 py-8 flex items-center justify-center">
        <div className={`max-w-md w-full ${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl shadow-2xl overflow-hidden p-8`}>
          <div className="text-center mb-6">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-purple-100 rounded-full mb-4">
              <i className="fas fa-envelope-open-text text-3xl text-purple-600"></i>
            </div>
          ...
          <form onSubmit={handleVerifyOTP} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 text-center text-2xl tracking-widest border ${darkMode ? 'border-gray-600 bg-gray-700 text-white' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none`}
                maxLength={6}
                required
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-purple-600 text-white font-semibold py-3 px-6 rounded-lg hover:bg-purple-700 focus:outline-none focus:ring-4 focus:ring-purple-300 transition-all shadow-lg disabled:opacity-50"
            >
